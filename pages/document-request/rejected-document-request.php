  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Rejected Document Request</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                ...
                while ($qry->fetch()){
                    echo "<tr>
                        <td class='text-center'>
                            <button class='btn btn-flat btn-info btn-xs' data-toggle='modal' data-target='#view-document_request_rejected-$request_id'><i class='nav-icon fas fa-eye'></i> View</button>
                        </td>
