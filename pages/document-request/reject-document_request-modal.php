      <div class="modal fade" id="reject-document_request-<?php echo $request_id; ?>">
        <div class="modal-dialog modal-md">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <input type="submit" class="btn btn-primary btn-flat" id="reject-document_request_btn" name="reject-document_request" value="Save">
            </div>
          </div>
            </form>
          <!-- /.modal-content -->
